date1=input('Enter a date(mm/dd/yyy)') #eisagwgh stin  morfi imerominias
d1=date1.split("/") #diaxwrismos kai paragwgh pinakwn 
...
if c1>c2:
   diafora=c1-c2
    ...
    diafora=c2-c1
print("Enter dates:",*d1,sep='/',end=' ') #elegxos megaluterwn kai ektupwsh
print(*d2,sep='/')
